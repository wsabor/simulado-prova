...
export default function ProvasPage() {
  ...
  return (
    <ProfessorLayout titulo="Gerenciar Provas" subtitulo={`${provas.length} provas criadas`}>
          ...
          {provas.map((prova) => (
            <div key={prova.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex gap-2 pt-4 border-t border-gray-200">
                ...
                <button
                  onClick={() => router.push(`/professor/provas/${prova.id}/correcao`)}
                  className="px-3 py-2 text-sm font-medium text-purple-700 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors"
                  title="Correção"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
