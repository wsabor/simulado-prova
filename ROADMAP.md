...
- [ ] **Cadastro de alunos em lote (CSV/planilha)** - Importar lista de chamada com nome, email, turma e gerar senha padrao
- [ ] **Exportar resultados para Excel/PDF** - Exportar tabela de resultados como CSV/Excel ou PDF com boletim da turma
- [ ] **Dashboard do professor dinamico** - Cards com valores reais (Total de Questoes, Provas Ativas, Alunos Cadastrados, Taxa de Conclusao)
- [ ] **Feedback por questao (acerto/erro)** - Adicionar campos "feedbackAcerto" e "feedbackErro" em cada questao, exibidos na revisao da prova pelo aluno e na correcao coletiva pelo professor em sala de aula
- [ ] **Revisao de prova pelo aluno** - Apos finalizar, poder revisar a prova vendo acertos/erros com gabarito e feedback (sem alterar)
- [ ] **Tela de correcao da prova pelo professor** - Exibir questoes de uma prova com gabarito e feedbacks para correcao e revisao coletiva com os alunos em sala
- [ ] **Reset de senha pelo professor** - Resetar senha de aluno pela interface (sem precisar acessar MongoDB)
...
- [ ] **Pagina de creditos** - Pagina com informacoes do desenvolvedor, versao do sistema, stack utilizada e agradecimentos
...
- [ ] **Modo escuro** - Implementar tema dark completo (ThemeToggle ja existe no header)
